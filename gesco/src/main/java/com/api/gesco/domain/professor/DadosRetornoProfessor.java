...
public record DadosRetornoProfessor(Long id, String nome, String foto, String cpf, String dataNascimento, Stream<String> email, Stream<String> telefone, DadosEnderecoSimplificado dadosEndereco, Stream<Diploma> diplomas, Stream<DisciplinaProfesor> disciplinaProfesor) {


    public DadosRetornoProfessor(Professor professor, Stream<EmailProfessor> emails, Stream<TelefoneProfessor> telefoneProfessor, EnderecoProfessor dadosEndereco, Stream<Diploma> diplomas, Stream<DisciplinaProfesor> disciplinaProfesor) {
        this(
                professor.getId(),
                professor.getNome(),
                professor.getFoto(),
