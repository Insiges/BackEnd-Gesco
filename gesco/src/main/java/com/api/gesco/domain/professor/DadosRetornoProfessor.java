...
public record DadosRetornoProfessor(Long id, String nome, String foto,String cpf, String dataNascimento, Stream<String> email, Stream<String> telefone, DadosEnderecoSimplificado dadosEndereco) {


    public DadosRetornoProfessor(Professor professor, Stream<EmailProfessor> emails, Stream<TelefoneProfessor> telefoneProfessor, EnderecoProfessor dadosEndereco) {
        this(
                professor.getId(),
                professor.getNome(),
                professor.getFoto(),
